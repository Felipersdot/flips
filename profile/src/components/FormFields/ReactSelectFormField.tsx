...
function ReactSelectFormField<T, L extends keyof T, V extends keyof T>(props: Props<T, L, V>): React.ReactElement<Props<T, L, V>> {
    ...
    const isInvalid = (((props.optionValue && props.value && props.value['value'].length === 0) || !props.value) && touched);
