...
const InlineDropdown = (props: InlineDropdownProps) => {
    return (
        <FormFieldInline withMarginRight={props.withMarginRight}>
            ...
            <SelectFormField sm="true" name={props.name} options={props.options} disabled={props.disabled} onChange={props.onChange} />
        </FormFieldInline>
    );
};
...
const FormFieldInline = styled.div<{ withMarginRight?: boolean }>`
    ...
    ${props => props.withMarginRight && css`margin-right: 10px;`};
